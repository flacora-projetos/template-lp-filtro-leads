export const FloatingWhatsApp = () => {
  return (
    ...
    >
      ...
      <span className="absolute -top-12 right-0 bg-white text-secondary-green text-sm px-3 py-1.5 rounded-lg shadow-md whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none font-medium">
        Fale com a equipe
      </span>
    </button>
  );
